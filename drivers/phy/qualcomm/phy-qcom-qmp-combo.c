...
#if 0
static const u32 usb3_data_lane_mapping[][4] = {
	[TYPEC_ORIENTATION_NORMAL] = { 1, 0 },
	[TYPEC_ORIENTATION_REVERSE] = { 2, 3 },
};

static const u32 dp_1_data_lanes_mapping[][4] = {
	[TYPEC_ORIENTATION_NORMAL] = { 0 },
	[TYPEC_ORIENTATION_REVERSE] = { 3 },
};

static const u32 dp_2_data_lanes_mapping[][4] = {
	[TYPEC_ORIENTATION_NORMAL] = { 3, 2 },
	[TYPEC_ORIENTATION_REVERSE] = { 0, 1 },
};

static const u32 dp_4_data_lanes_mapping[][4] = {
	[TYPEC_ORIENTATION_NORMAL] = { 3, 2, 1, 0 },
	[TYPEC_ORIENTATION_REVERSE] = { 0, 1, 2, 3 },
};
#endif
