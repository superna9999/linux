...
static const unsigned int pwm_a_ao3_pins[]	= { PIN(GPIOAO_3, 0) };
static const unsigned int pwm_a_ao6_pins[]	= { PIN(GPIOAO_6, 0) };
static const unsigned int pwm_a_ao12_pins[]	= { PIN(GPIOAO_12, 0) };
static const unsigned int pwm_b_ao_pins[]	= { PIN(GPIOAO_13, 0) };
...
static struct meson_pmx_group meson_gxbb_aobus_groups[] = {
	...
	GROUP(pwm_a_ao3, 	0,	22),
	GROUP(pwm_a_ao6, 	0,	18),
	GROUP(pwm_a_ao12, 	0,	17),
	GROUP(pwm_b_ao, 	0,	3),
};
...
static const char * const pwm_a_ao3_groups[] = {
	"pwm_a_ao3",
};

static const char * const pwm_a_ao6_groups[] = {
	"pwm_a_ao6",
};

static const char * const pwm_a_ao12_groups[] = {
	"pwm_a_ao12",
};
