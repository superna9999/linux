...
static const struct drm_panel_funcs tdo_tl070wsh30_panel_funcs = {
	.enable = tdo_tl070wsh30_panel_enable,
	.disable = tdo_tl070wsh30_panel_disable,
...
static int tdo_tl070wsh30_panel_add(struct tdo_tl070wsh30_panel *tdo_tl070wsh30)
{
	...
	drm_panel_init(&tdo_tl070wsh30->base);
	tdo_tl070wsh30->base.dev = &tdo_tl070wsh30->link->dev;
	tdo_tl070wsh30->base.funcs = &tdo_tl070wsh30_panel_funcs;

	tdo_tl070wsh30->backlight = devm_of_find_backlight(dev);
