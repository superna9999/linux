				    ...
				    struct drm_plane_state *state)
{
	...
	/* TOFIX can_position could be true */
					...
					struct drm_plane_state *old_state)
{
	...
	case DRM_FORMAT_RGB888:
		...
		priv->viu.vd1_if0_canvas0 = CANVAS_ADDR2(MESON_CANVAS_ID_VD1_0) |
					    CANVAS_ADDR1(MESON_CANVAS_ID_VD1_0) |
	...
	case DRM_FORMAT_NV21:
		...
		priv->viu.vd1_if0_canvas0 = CANVAS_ADDR2(MESON_CANVAS_ID_VD1_1) |
